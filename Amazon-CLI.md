*Fazer o download do Amazon CLI pelo site da AWS*

# Amazon CLI

### Criando tabela 
- nome: Music, 
- atributos: Artists (string), SongTitle (string); 
- chaves: Artist (hash), SongTitle (range); 
- capacidade: leitura (10 unidades) e escrita (5 unidades)
...
### Inserindo um item (itemmusic.json)
...
### Inserindo múltiplos itens (arquivo contendo um lote de itens)
...
- Atributo: AlbumTitle, tipo: S (string)
- Cria elementos de index
...
### Pesquisando item por artista e título da música (com base em um arquivo com os dados a serem inseridos)
